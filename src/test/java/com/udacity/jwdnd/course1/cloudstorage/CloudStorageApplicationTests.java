...
class CloudStorageApplicationTests {
    ...
    public void createNote() throws InterruptedException {
        // signup the user
        doMockSignUp("qqq", "qqq", "admin", "123");
        ...
        inputTitle.click();
        inputTitle.sendKeys("Test Create Note");
        ...
        Assertions.assertTrue(driver.findElement(By.id("table-note-title")).getText().contains("Test Create Note"));
        Thread.sleep(3000);
    ...
    public void createCredential() throws InterruptedException {
        // signup the user
        doMockSignUp("qqq", "qqq", "quang", "123");
    ...
    public void editCredentials() throws InterruptedException {
        ...
        inputURL.click();
        inputURL.clear();
        inputURL.sendKeys("https://github.com");
        ...
        // check changes
        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("credentialTable")));
        Assertions.assertTrue(driver.findElement(By.id("table-cred-url")).getText().contains("https://github.com"));
